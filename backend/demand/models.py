...
class Post(models.Model):
    ...
    poster = models.ForeignKey('user.User', on_delete=models.SET_NULL, null=True, blank=True)
...
class Apply(models.Model):
    ...
    applicant = models.ForeignKey('user.User', on_delete=models.SET_NULL, null=True, blank=True)
